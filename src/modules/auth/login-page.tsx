...
export function LoginPage() {
  ...
  return (
    <main
      className={[
        "login-screen flex min-h-[100dvh] items-start justify-center bg-[radial-gradient(circle_at_top,_rgba(251,191,36,0.18),_transparent_28%),linear-gradient(180deg,_#f7f4ee_0%,_#efe7dc_46%,_#e8ddd1_100%)] px-4 pb-8 pt-[12vh] text-stone-900 sm:min-h-screen sm:pt-20",
    ...
    >
      <div className="w-full max-w-md">
        <section
          className={[
            "login-card rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-[0_28px_80px_rgba(120,113,108,0.18)] backdrop-blur sm:p-8",
        ...
        <p className="mt-12 text-center text-xs uppercase tracking-[0.18em] text-stone-400 sm:mt-14">
          Acceso privado para operacion interna del taller
        </p>
      </div>
    </main>
  );
